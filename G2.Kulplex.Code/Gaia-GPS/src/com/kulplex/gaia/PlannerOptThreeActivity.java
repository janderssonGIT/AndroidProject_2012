/**
 * PlannerOptThreeActivity.java
 * 
 * This activity takes an input of coordinates and sends the data to the Loading.java.
 * 
...
public class PlannerOptThreeActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        OTB.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
            	...
            	Intent intent = new Intent(PlannerOptThreeActivity.this, PlannerActivity.class);
            	startActivity(intent);
                finish(); 
            }

        });
        //Defines a variable and sets the input type for EditText
        ...
        L1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(PlannerOptThreeActivity.this, Loading.class);	                    
                //Casts user input into variables
